...
public class IntCodeTests {
	...
	public void inputOutputTest() {
		...
		IntcodeMachine program = new IntcodeMachine(memory).setInput(Arrays.asList(7));
	...
	public void EqualsReturnsTrueWhenImmediateEqualsTest() {
		...
		IntcodeMachine program = new IntcodeMachine(memory).setInput(Arrays.asList(8));
	...
	public void LessThanReturnsFalseWhenImmediateGreaterTest() {
		int[] memory = new int[] {3,3,1107,-1,8,3,4,3,99};
		IntcodeMachine program = new IntcodeMachine(memory).setInput(Arrays.asList(9));
